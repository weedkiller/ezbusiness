...
namespace EzBusiness_ViewModels.Models.PurchaseMgmt
{
    public class PurchaseOrderVM
    {
        ...
        public List<SelectListItem> POfromList { get; set; }
        ...
        public List<PurchaseOrderDetailnew> PurchaseOrderDetailsnew { get; set; }

        public PurchaseOrderDetailnew PODetail { get; set; }

        public PurchaseOrderDetailnew MReqDetail { get; set; }
        ...
        public List<SelectListItem> POReqList { get; set; }

        public List<SelectListItem> POReqItemList { get; set; }

    }
    public class PurchaseOrderDetailnew
    {

...
namespace EzBusiness_Web.Helper
{
    /// <summary>
...
#region Commented 
    ...
    //    public static T FindDescendant<T>(this T searchRoot, string id)
    //        where T : class, ITreeNode<T>
    //    {
    ...
    //    /// Returns null if the node cannot be found.</summary>
    //    public static T FindTreeNode<T>(this IEnumerable<T> trees, string id)
    //        where T : class, ITreeNode<T>
    //    {
